...
class StockPicking(models.Model):
    ...
    def button_validate(self):
        ...
        if pickings_not_to_backorder :
            if pickings_not_to_backorder.picking_type_code == 'outgoing' :
                move_type = 'sale'
            if pickings_not_to_backorder.picking_type_code == 'incoming' :
                move_type = 'return'
            move_obj = pickings_not_to_backorder
        if pickings_to_backorder :
            if pickings_to_backorder.picking_type_code == 'outgoing' :
                move_type = 'sale'
            if pickings_to_backorder.picking_type_code == 'incoming' :
                move_type = 'return'
