...
class ResPartner(models.Model):
    ...
    credit_check = fields.Boolean('Active Credit Limit')
    credit_warning = fields.Monetary('Warning Amount')
    credit_blocking = fields.Monetary('Blocking Amount')
    amount_due = fields.Monetary(string='Due Amount', compute='_compute_amount_due')

    days_check = fields.Boolean('Active Day\'s Limit')
    days_warning = fields.Integer('Warning Day')
    days_blocking = fields.Integer('Blocking Day')
